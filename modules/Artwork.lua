...
-- as finished full-color art (a tint would only muddy it). It is MEASURED from the pixels by the
-- generator, not declared: art that is unsaturated and near-white carries its shape in the alpha
-- channel and takes a tint cleanly; anything else has its own palette and forces the tint to white.
--
