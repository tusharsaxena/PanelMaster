...
![Tests](https://img.shields.io/badge/Tests-902%2F902_passing-green)
...
`/pm panels` lists what you have, with anything switched off shown in gray. **Show on mouseover only** fades a panel away
...
| The settings page is covered with "Settings are locked during combat." | Nothing is wrong: settings cannot be changed while you are in combat. The page comes back, live and up to date, the moment combat ends. |
