...
```
grep -n '[Bb]undles' PanelMaster/CLAUDE.md
```
...
```
diff -r --strip-trailing-cr <tag>/LibKa0s PanelMaster/libs/LibKa0s   # 1 file: OptionsCompose.lua
diff -r --strip-trailing-cr <tag>/testkit PanelMaster/tests/_kit     # empty
```
