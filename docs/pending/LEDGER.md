...
| DOC-04 | 904842e7 | `docs/ARCHITECTURE.md` ▸ Known limitations | 🟡 deferred | 2026-07-31 | Documented design decision with its reasoning already written. `level` remains settable from the CLI. |
...
| ISS-05 | 49dec1eb | GitHub #5 | 🟢 done | 2026-07-31 | As ISS-03. |
| ISS-06 | f661d445 | GitHub #9 | 🟡 deferred | 2026-07-31 | "Defer for now." Filed deliberately as future work, same posture as ISS-02; the audit plan already carries per-panel texture selection under *Deferred features*. Issue #9 is the tracker. |
