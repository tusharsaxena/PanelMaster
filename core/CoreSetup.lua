...
--     settings/Schema.lua, settings/Slash.lua, settings/PanelEditor.lua, settings/PanelEditorTabs.lua and
--     settings/Panel.lua. All six load after core/, so the whole core/ block satisfies this. core/DebugLogSetup.lua is
